...
function setFocus(t, e = {}) {
  ...
  function onBlur() {
    let i
    (i = e.onBlur) == null || i.call(t), n || t.removeAttribute('tabindex')
  }
...
class ElementError extends GOVUKFrontendError {
  constructor(t) {
    ...
    if (isObject(t)) {
      ...
      ;(e = n),
        (e += s
          ? ` is not of type ${o != null ? o : 'HTMLElement'}`
          : ' not found'),
        i && (e = formatErrorMessage(i, e))
    }
...
class ConfigurableComponent extends Component {
  ...
  constructor(e, i) {
    ...
    const s = (function (Component, t) {
      ...
      const e = {};
        const i = Object.entries(Component.schema.properties)
      for (const n of i) {
        const [i, s] = n;
          const o = i.toString()
        o in t && (e[o] = normaliseString(t[o], s)),
          (s == null ? void 0 : s.type) === 'object' &&
            (e[o] = extractConfigByNamespace(Component.schema, t, i))
      }
      return e
    })(n, this._$root.dataset)
    this._config = mergeConfigs(n.defaults, i != null ? i : {}, this[t](s), s)
  }
}
function normaliseString(t, e) {
  const i = t ? t.trim() : ''
  let n;
    let s = e == null ? void 0 : e.type
  switch (
    (s ||
...
function normaliseOptions(t) {
  ...
  if (isObject(t)) {
    const n = t
    ;(isScope(n.scope) || n.scope === null) && (i = n.scope),
      typeof n.onError === 'function' && (e = n.onError)
  }
  return (
    isScope(t)
      ? (i = t)
...
function extractConfigByNamespace(t, e, i) {
  ...
  if ((n == null ? void 0 : n.type) !== 'object') return
  const s = { [i]: {} }
...
class I18n {
  constructor(t = {}, e = {}) {
    ...
    ;(this.translations = void 0),
      ...
      (this.translations = t),
      (this.locale =
        (i = e.locale) != null ? i : document.documentElement.lang || 'en')
  }
  t(t, e) {
    if (!t) throw new Error('i18n: lookup key missing')
    let i = this.translations[t]
    if (typeof (e == null ? void 0 : e.count) === 'number' && isObject(i)) {
  ...
  replacePlaceholders(t, e) {
    ...
    return t.replace(/%{(.\S+)}/g, function (t, n) {
      if (Object.prototype.hasOwnProperty.call(e, n)) {
        const t = e[n]
        return !1 === t || (typeof t !== 'number' && typeof t !== 'string')
          ? ''
          : typeof t === 'number'
            ? i
              ? i.format(t)
...
class Accordion extends ConfigurableComponent {
  ...
  constructHeaderMarkup(t, e) {
    const i = t.querySelector(`.${this.sectionButtonClass}`);
      const n = t.querySelector(`.${this.sectionHeadingClass}`);
      const s = t.querySelector(`.${this.sectionSummaryClass}`)
    if (!n)
      {throw new ElementError({
        component: Accordion,
    ...
    for (const d of Array.from(i.attributes))
      {d.name !== 'id' && o.setAttribute(d.name, d.value)}
  ...
  setExpanded(t, e) {
    const i = e.querySelector(`.${this.upChevronIconClass}`);
      const n = e.querySelector(`.${this.sectionShowHideTextClass}`);
...
class CharacterCount extends ConfigurableComponent {
  ...
  constructor(t, e = {}) {
    ...
    const o = (function (t, e) {
      ...
      for (const [n, s] of Object.entries(t)) {
        ...
        if (Array.isArray(s)) {
          ...
          n !== 'anyOf' || s.length - t.length >= 1 || i.push(...t)
        }
      }
      return i
    ...
    ;(this.i18n = new I18n(this.config.i18n, {
      ...
      (this.maxLength =
        (i = (n = this.config.maxwords) != null ? n : this.config.maxlength) !=
        null
          ? i
          : 1 / 0),
      (this.$textarea = s)
...
class ErrorSummary extends ConfigurableComponent {
  ...
  getAssociatedLegendOrLabel(t) {
    ...
    return (e = document.querySelector(`label[for='${t.getAttribute('id')}']`)) !=
      null
      ? e
      : t.closest('label')
  }
  ...
  canDrop(t) {
    return t.items.length
      ? this.matchesInputCapacity(
          (function (t) {
            let e = 0
            for (let i = 0; i < t.length; i++) t[i].kind === 'file' && e++
            return e
          })(t.items)
        )
...
class PasswordInput extends ConfigurableComponent {
  ...
  toggle(t) {
    t.preventDefault(),
      this.$input.type !== 'password' ? this.hide() : this.show()
  }
  show() {
    this.setType('text')
  }
  ...
  setType(t) {
    ...
    const e = t === 'password';
      const i = e ? 'show' : 'hide';
      const n = e ? 'passwordHidden' : 'passwordShown'
...
class Tabs extends Component {
  constructor(t) {
    ...
    const i = this.$root.querySelector('.govuk-tabs__list');
      const n = this.$root.querySelectorAll('li.govuk-tabs__list-item')
    if (!i)
      {throw new ElementError({
        component: Tabs,
  ...
  setup() {
    ...
    const e =
      (t = this.getTab(window.location.hash)) != null ? t : this.$tabs[0]
    this.showTab(e),
...
function initAll(t = {}) {
  ...
  try {
    ...
    return void (i.onError ? i.onError(n, { config: e }) : console.log(n))
  }
  ;[
...
function createAll(Component, t, e) {
  ...
  try {
    ...
    i =
      (s = n.scope) == null
        ? void 0
        : s.querySelectorAll(`[data-module="${Component.moduleName}"]`)
  } catch (o) {
    return (
      n.onError
        ? n.onError(o, { component: Component, config: t })
        : console.log(o),
      []
    )
  }
  return Array.from(i != null ? i : [])
    .map((e) => {
      try {
        ...
        return (
          n.onError
            ? n.onError(o, { element: e, component: Component, config: t })
            : console.log(o),
          null
        )
      }
